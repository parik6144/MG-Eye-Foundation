...
export default function ContactPage() {
  ...
  return (
    <div className="bg-white">
      <section className="relative overflow-hidden pt-28 pb-16 bg-[#0F172A]">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1118E8]/40 via-transparent to-[#FF741F]/20" />
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <a href={SITE.phoneHref} className="rounded-[22px] bg-white border border-[#e2e8f0] p-6 shadow-lg shadow-[#1118E8]/5 hover:border-[#1118E8]/30 transition-colors">
          ...
          <a href={SITE.whatsapp} target="_blank" rel="noreferrer" className="rounded-[22px] bg-white border border-[#e2e8f0] p-6 shadow-lg shadow-[#1118E8]/5 hover:border-[#25d366]/40 transition-colors">
            <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#25d366] text-white">
              <MessageCircle className="w-5 h-5" />
            </span>
            <p className="mt-4 text-xs font-semibold tracking-[0.16em] uppercase text-[#FF741F]">WhatsApp</p>
          ...
          <a href={SITE.emailHref} className="rounded-[22px] bg-white border border-[#e2e8f0] p-6 shadow-lg shadow-[#1118E8]/5 hover:border-[#1118E8]/30 transition-colors">
          ...
          <div className="rounded-[22px] bg-white border border-[#e2e8f0] p-6 shadow-lg shadow-[#1118E8]/5">
          ...
          <div className="rounded-[28px] bg-[#F7F9FC] border border-[#e2e8f0] p-7 sm:p-9">
            {formSubmitted ? (
              <div className="text-center py-16">
                <CheckCircle2 className="w-12 h-12 text-[#1118E8] mx-auto mb-4" />
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-4 py-3.5 rounded-2xl border border-[#e2e8f0] bg-white outline-none focus:border-[#1118E8]"
                />
                <input
                  required
                  type="tel"
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3.5 rounded-2xl border border-[#e2e8f0] bg-white outline-none focus:border-[#1118E8] resize-none"
                />
                {error ? <p className="text-sm text-[#FF0808] bg-red-50 border border-red-100 rounded-xl px-3 py-2 break-all">{error}</p> : null}
                <button type="submit" disabled={sending} className="w-full bg-[#1118E8] hover:bg-[#0d12b8] text-white font-bold rounded-full py-4 text-sm disabled:opacity-60">
