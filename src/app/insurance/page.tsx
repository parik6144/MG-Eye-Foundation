...
export const metadata: Metadata = { title: "Insurance & Self-Pay | M G Eye Foundation" };

export default function InsurancePage() {
  return (
    <div className="pt-6 pb-8 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <PageBreadcrumb items={[{ label: "Insurance" }]} />
        <span className="mt-4 block text-[#1F8A9A] text-sm font-semibold tracking-[0.18em] uppercase">
          Insurance & Self-Pay
        </span>
