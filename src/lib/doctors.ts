export const DOCTORS = [
  {
    ...
    label: "M.B.B.S, D.N.B (Ophthalmology) | Cataract, medical retina and trauma specialist",
    qual: "M.B.B.S, D.N.B (Ophthalmology)",
    spec: "Cataract, Medical Retina and Trauma specialist",
  ...
  },
  {
    ...
    label: "M.B.B.S, M.S (Ophthalmology), F.P.O.A.S | Pediatric Ophthalmologist, Cataract and Squint specialist",
    qual: "M.B.B.S, M.S (Ophthalmology), F.P.O.A.S",
    spec: "Pediatric Ophthalmologist, Cataract and Squint specialist",
    role: "Ex Fellow, Aravind Eye Hospital, Madurai",
    showLabel: false,
    showQual: true,
    showMemberships: false,
    bio: "DR MALAY KUMAR DWIVEDI is a dedicated ophthalmologist with specialized training in Paediatric Ophthalmology, providing comprehensive eye care for infants, children, and adolescents. With a compassionate and child-friendly approach, DR MALAY KUMAR DWIVEDI focuses on the early detection, diagnosis, and management of eye and vision problems during the crucial years of visual development.",
    extraBio: [
    ...
    stats: [{ value: "18+", label: "Years of experience" }],
    expertise: [
      "ROP screening",
      "Cataract",
      "Squint / Strabismus",
